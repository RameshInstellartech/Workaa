...
private let kSymmetricCryptorRandomStringGeneratorCharset: [Character] = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^&*()_-".characters.map({$0})
...
//        case .aes_256: return kCCBlockSizeAES128 // AES256 still requires 256 bits IV
        case .aes_256: return 16 // AES256 still requires 256 bits IV
        }
    }
